...
<head>
   ...
   <script>
      ...
      $(document).ready(function() {
         $("#sensors_refresh").load("api/getSensors.php?divisaoPage=Quarto");
      ...
      $(document).ready(function() {
         $("#devices_refresh").load("api/getDevices.php?divisaoPage=Quarto");
         setInterval(function() {
            $("#devices_refresh").load("api/getDevices.php?divisaoPage=Quarto");
         }, 1000);
      });
   ...
   <!-- CSS que apenas se aplicam ao Quarto -->
   <!-- (Nota: Como a CSS especifica para o Quarto é apenas a parte em baixo que se refere ao body decidimos usar CSS Internas 
   devido a não haver necessidade de criar um novo ficheiro para tão pouco código) -->
   <style>
      body {
         background-image: url("./src/img/rooms/bedroom.jpg");
                  ...
                  <div class="modal-body">
                     <form action="api/sendModal.php" method="POST">
                        <div class="form-group">
                           <label for="idRange" class="form-label">Valor:</label>
                           <input type="range" name="idRange" class="form-range" min="0" max="100" id="idRange" value="50">
                           <input type="hidden" name="idID" id="idID"/>
                           <input type="hidden" name="divisaoPage" id="divisaoPage" value="Quarto"/>
                        </div>
