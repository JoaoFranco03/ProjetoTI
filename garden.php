...
<head>
   ...
   <script>
      ...
      $(document).ready(function() {
         $("#sensors_refresh").load("api/getSensors.php?divisaoPage=Jardim");
      ...
      $(document).ready(function() {
         $("#devices_refresh").load("api/getDevices.php?divisaoPage=Jardim");
         setInterval(function() {
            $("#devices_refresh").load("api/getDevices.php?divisaoPage=Jardim");
         }, 1000);
      });
   ...
   <!-- CSS que apenas se aplicam ao Jardim -->
   <!-- (Nota: Como a CSS especifica para o Jardim é apenas a parte em baixo que se refere ao body decidimos usar CSS Internas 
   devido a não haver necessidade de criar um novo ficheiro para tão pouco código) -->
   <style>
      body {
         background-image: url("./src/img/rooms/garden.jpg");
               ...
               <ul class="nav nav-justified">
                  ...
                  <div class="nav-item dropup">
                     ...
                     <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="kitchen.php"><i class="fa-solid fa-kitchen-set"></i>&nbsp&nbspJardim</a></li>
               ...
               <div class="modal-body">
                  <form action="api/sendModal.php" method="POST">
                     <div class="form-group">
                        ...
                        <input type="hidden" name="divisaoPage" id="divisaoPage" value="Jardim" />
                     </div>
