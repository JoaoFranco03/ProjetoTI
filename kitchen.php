...
<head>
   ...
   <script>
      ...
      $(document).ready(function() {
         $("#sensors_refresh").load("api/getSensors.php?divisaoPage=Cozinha");
      ...
      $(document).ready(function() {
         $("#devices_refresh").load("api/getDevices.php?divisaoPage=Cozinha");
         setInterval(function() {
            $("#devices_refresh").load("api/getDevices.php?divisaoPage=Cozinha");
         }, 1000);
      });
   ...
   <!-- CSS que apenas se aplicam ao Cozinha -->
   <!-- (Nota: Como a CSS especifica para o Cozinha é apenas a parte em baixo que se refere ao body decidimos usar CSS Internas 
   devido a não haver necessidade de criar um novo ficheiro para tão pouco código) -->
   <style>
      body {
         background-image: url("./src/img/rooms/kitchen.jpg");
               ...
               <div class="modal-body">
                  <form action="api/sendModal.php" method="POST">
                     <div class="form-group">
                        ...
                        <input type="hidden" name="divisaoPage" id="divisaoPage" value="Cozinha" />
                     </div>
