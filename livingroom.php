...
<head>
   ...
   <script>
      ...
      $(document).ready(function() {
         $("#sensors_refresh").load("api/getSensors.php?divisaoPage=Sala_de_Estar");
      ...
      $(document).ready(function() {
         $("#devices_refresh").load("api/getDevices.php?divisaoPage=Sala_de_Estar");
         setInterval(function() {
            $("#devices_refresh").load("api/getDevices.php?divisaoPage=Sala_de_Estar");
         }, 1000);
      });
   ...
   <!-- CSS que apenas se aplicam ao Sala_de_Estar -->
   <!-- (Nota: Como a CSS especifica para o Sala_de_Estar é apenas a parte em baixo que se refere ao body decidimos usar CSS Internas 
   devido a não haver necessidade de criar um novo ficheiro para tão pouco código) -->
   <style>
      body {
         background-image: url("./src/img/rooms/living-room.jpg");
...
<body>
   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-7">
            <h1 class="room">Sala de Estar</h1>
         </div>
         <div class="col-5">
            <div class="float-end">
               ...
               <ul class="nav nav-justified">
                  ...
                  <div class="nav-item dropup">
                     ...
                     <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="kitchen.php"><i class="fa-solid fa-kitchen-set"></i>&nbsp&nbspSala_de_Estar</a></li>
               ...
               <div class="modal-body">
                  <form action="api/sendModal.php" method="POST">
                     <div class="form-group">
                        ...
                        <input type="hidden" name="divisaoPage" id="divisaoPage" value="Sala_de_Estar" />
                     </div>
