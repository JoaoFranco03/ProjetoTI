         ...
         if ($_SERVER['REQUEST_METHOD'] == 'GET') {
             ...
             {           
                 ...
                 <div class="text-center">
                     <strong class="text-center">Username já existente, por favor insira outro.</strong>
                 </div>
             </div>'; 
             }
         }
      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-7 col-sm-12 h-100 my-auto">
               ...
               <form action = "api/register.php" onsubmit = "return validation()" method = "POST">
                  ...
                  <div class="form-check">
                     <input style="margin-top: 2px; width: 20px; height: 20px;" class="form-check-input" name="check" type="checkbox" id="checkbox" id="flexCheckDefault">
                     <label style="margin-top: 0px; margin-left: 15px; margin-bottom: 30px;" class="form-check-label" for="flexCheckDefault">
